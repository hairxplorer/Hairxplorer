...
def init_db():
    ...
    # Table clinics : configuration de chaque clinique (incluant email et pricing)
...
def send_email(to_email: str, subject: str, body: str):
    ...
    SMTP_SERVER = "smtp.example.com"   # À remplacer
    SMTP_PORT = 587                    # À remplacer
    SMTP_USER = "ton_email@example.com"  # À remplacer
    SMTP_PASSWORD = "ton_mot_de_passe"     # À remplacer
...
async def analyze(
    ...
    try:
        ...
        if clinic_config and "pricing" in clinic_config:
            pricing = clinic_config["pricing"]  # Ex : {"7": 4000, "6": 3500, "5": 3000}
