...
DATABASE_PATH = os.path.join(os.path.dirname(__file__), '..', 'clinics', 'config.db')  # Chemin absolu et correct
...
async def admin_dashboard(request: Request, db: sqlite3.Connection = Depends(get_db)):
    try:
        ...
        for clinic in clinics:
            ...
            except (json.JSONDecodeError, TypeError): #Gestion des erreurs
