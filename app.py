...
async def analyze(
    ...
    try:
        ...
        # )
        return {"status": "success", "message": "Analyze endpoint reached (simplified).", "quota": new_quota, "api_key": api_key, "client_email": client_email, "consent": str(consent).lower()} #On retourne les infos
